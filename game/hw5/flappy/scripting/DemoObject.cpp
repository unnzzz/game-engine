...
int DemoObject::current_guid = 0;
std::vector<DemoObject*> DemoObject::game_objects;

/**
 * Initialize position to (0,0); set guid to incrementing value based on
 * number of objects
 */
DemoObject::DemoObject() : x(0), y(0)
{
	guid = "DemoObject" + std::to_string(current_guid);
	current_guid++;
 ...
 */
v8::Local<v8::Object> DemoObject::exposeToV8(v8::Isolate *isolate, v8::Local<v8::Context> &context, std::string context_name)
{
	std::vector<v8helpers::ParamContainer<v8::AccessorGetterCallback, v8::AccessorSetterCallback>> v;
	v.push_back(v8helpers::ParamContainer("x", getDemoObjectX, setDemoObjectX));
	v.push_back(v8helpers::ParamContainer("y", getDemoObjectY, setDemoObjectY));
	v.push_back(v8helpers::ParamContainer("guid", getDemoObjectGUID, setDemoObjectGUID));
...
void DemoObject::setDemoObjectX(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	static_cast<DemoObject*>(ptr)->x = value->Int32Value();
}

void DemoObject::getDemoObjectX(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	int x_val = static_cast<DemoObject*>(ptr)->x;
	info.GetReturnValue().Set(x_val);
}


void DemoObject::setDemoObjectY(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	static_cast<DemoObject*>(ptr)->y = value->Int32Value();
}

void DemoObject::getDemoObjectY(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	int y_val = static_cast<DemoObject*>(ptr)->y;
	info.GetReturnValue().Set(y_val);
}

void DemoObject::setDemoObjectGUID(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<void>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	v8::String::Utf8Value utf8_str(info.GetIsolate(), value->ToString());
	static_cast<DemoObject*>(ptr)->guid = *utf8_str;
}

void DemoObject::getDemoObjectGUID(v8::Local<v8::String> property, const v8::PropertyCallbackInfo<v8::Value>& info)
{
	v8::Local<v8::Object> self = info.Holder();
	v8::Local<v8::External> wrap = v8::Local<v8::External>::Cast(self->GetInternalField(0));
	void* ptr = wrap->Value();
	std::string guid = static_cast<DemoObject*>(ptr)->guid;
 ...
 */
void DemoObject::ScriptedDemoObjectFactory(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	DemoObject *new_object = new DemoObject();

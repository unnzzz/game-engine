...
int main(int argc, char** argv)
{
    ...
    { // anonymous scope for managing handle scope
		...
		// Bind the global static factory function for creating new DemoObject instances
		global->Set(isolate, "DemoObjectfactory", v8::FunctionTemplate::New(isolate, DemoObject::ScriptedDemoObjectFactory));
		...
		do
		{
			...
			if(c!='\n')
			{
				...
				{
					std::cout << "List of current DemoObjects" << std::endl;
					for(DemoObject *g : DemoObject::game_objects)
					{

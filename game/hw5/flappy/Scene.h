...
class Scene
{
    public:
        ...
        static void lose(const v8::FunctionCallbackInfo<v8::Value> &args);
    ...
    private:
        ...
        //list of collision components that character can collide with
        std::vector<CollisionComponent*> collidables;
